...
exec(compile(runtime_safety.read_text(encoding="utf-8"), str(runtime_safety), "exec"), {"__file__": str(runtime_safety), "__name__": "__main__"})
prepared_generation_safety = Path(__file__).with_name("apply_prepared_generation_safety.py")
exec(compile(prepared_generation_safety.read_text(encoding="utf-8"), str(prepared_generation_safety), "exec"), {"__file__": str(prepared_generation_safety), "__name__": "__main__"})
prepared_fastpath_safety = Path(__file__).with_name("apply_prepared_fastpath_safety.py")
exec(compile(prepared_fastpath_safety.read_text(encoding="utf-8"), str(prepared_fastpath_safety), "exec"), {"__file__": str(prepared_fastpath_safety), "__name__": "__main__"})
...
exec(compile(diagnostics_hotpath.read_text(encoding="utf-8"), str(diagnostics_hotpath), "exec"), {"__file__": str(diagnostics_hotpath), "__name__": "__main__"})
feature_retention = Path(__file__).with_name("apply_feature_retention_preflight.py")
exec(compile(feature_retention.read_text(encoding="utf-8"), str(feature_retention), "exec"), {"__file__": str(feature_retention), "__name__": "__main__"})
...
exec(compile(v32_foundation.read_text(encoding="utf-8"), str(v32_foundation), "exec"), {"__file__": str(v32_foundation), "__name__": "__main__"})
v32_hibernation = Path(__file__).with_name("apply_v32_hibernation_compat.py")
exec(compile(v32_hibernation.read_text(encoding="utf-8"), str(v32_hibernation), "exec"), {"__file__": str(v32_hibernation), "__name__": "__main__"})
v32_adaptive_v2 = Path(__file__).with_name("apply_v32_adaptive_v2.py")
exec(compile(v32_adaptive_v2.read_text(encoding="utf-8"), str(v32_adaptive_v2), "exec"), {"__file__": str(v32_adaptive_v2), "__name__": "__main__"})
v32_renderer_profiling = Path(__file__).with_name("apply_v32_renderer_profiling.py")
exec(compile(v32_renderer_profiling.read_text(encoding="utf-8"), str(v32_renderer_profiling), "exec"), {"__file__": str(v32_renderer_profiling), "__name__": "__main__"})
v33_framepacing_gpu = Path(__file__).with_name("apply_v33_framepacing_gpu.py")
exec(compile(v33_framepacing_gpu.read_text(encoding="utf-8"), str(v33_framepacing_gpu), "exec"), {"__file__": str(v33_framepacing_gpu), "__name__": "__main__"})
v33_tail_gpu = Path(__file__).with_name("apply_v33_tail_gpu_experiments.py")
exec(compile(v33_tail_gpu.read_text(encoding="utf-8"), str(v33_tail_gpu), "exec"), {"__file__": str(v33_tail_gpu), "__name__": "__main__"})
