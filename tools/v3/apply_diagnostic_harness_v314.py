...
new = '''packaging = Path(__file__).with_name("apply_lab_packaging_v314_fixed.py")'''
if text.count(old) != 1:
    raise RuntimeError("Unable to route V3.14 harness to V3.14 compatibility packager")
