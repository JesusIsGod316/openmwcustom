...
namespace MWGui
{
    ...
    bool Repair::onControllerButtonEvent(const SDL_GamepadButtonEvent& arg)
    {
        if ((arg.button == SDL_GAMEPAD_BUTTON_SOUTH && !mToolBox->getVisible()) || arg.button == SDL_GAMEPAD_BUTTON_NORTH)
        {
